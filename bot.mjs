...
async function analyzeImage(imageBuffer, chatId) {
  try {
    ...
    Используйте следующую структуру и HTML-теги Telegram для форматирования:

    <b>Основное содержание:</b>
    ...
    Используйте <b>жирный текст</b> для заголовков, <i>курсив</i> для выделения важных деталей, 
    и маркированные списки для перечисления. Будьте кратки, но информативны.`;
